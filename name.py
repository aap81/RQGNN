...
group1 = ["MOLT-4", "Mutagenicity", "SW-620", "NCI-H23"]
group2 =  ["PC-3", "MCF-7", "NCI109", "AIDS"] # done
group3 = ["DD", "NCI1", "SF-295", "OVCAR-8"]
group4 = ["OVCAR-8", "P388", "PROTEINS"]
group5 = ["SN12C", "UACC257", "NCI-H23", "NCI109"]
group6 = ["NCI-H23","NCI109", "P388"]
